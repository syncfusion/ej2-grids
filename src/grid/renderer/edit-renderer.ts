...
export class EditRender {
    ...
    public addNew(args: {
        ...
        type?: string, cell?: Element, row?: Element, primaryKeyValue?: string[]
    }): void {
    ...
    private convertWidget(args: { rowData?: Object, columnName?: string, type?: string }): void {
        ...
        for (let col of cols) {
            ...
            (col.edit.write as Function)({ rowData: args.rowData, element: cell, column: col, type: args.type });
    ...
    private getEditElements(args: { rowData?: Object, columnName?: string, type?: string, row?: Element }): Object {
        let gObj: IGrid = this.parent;
        let elements: Object = {};
        let cols: Column[] = gObj.editSettings.mode !== 'batch' ? gObj.columns as Column[] : [gObj.getColumnByField(args.columnName)];
        for (let col of cols) {
            ...
            let tArgs: Object = { column: col, value: value, type: args.type };
