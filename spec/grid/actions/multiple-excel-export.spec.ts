...
describe('multiple-grid-exporting', () => {
    ...
    it('multiexport without saving the book', (done) => {
        let excelExp: Promise<any> = gridObj1.excelExport(appendExcelExportProperties, true);
...
describe('multiple grid exporting with header and footer', () => {
    let gridObj1: Grid;
    let elem1: HTMLElement = createElement('div', { id: 'Grid1' });
    let gridObj2: Grid;
    let elem2: HTMLElement = createElement('div', { id: 'Grid2' });
    ...
    let gBook: any;
    it('multiexport without saving the book', (done) => {
        let excelExp: Promise<any> = gridObj1.excelExport(newExcelExportProperties, true);
        excelExp.then((data: any) => {
            gBook = data;
            done();
        });
    ...
    it('multiexport with saving the book', (done) => {
        let excelExp: Promise<any> = gridObj3.excelExport(newExcelExportProperties, false, gBook);
        excelExp.then((data: any) => {
            done();
        });
    });
});
describe('multiple grid exporting with header', () => {
    let gridObj1: Grid;
    let elem1: HTMLElement = createElement('div', { id: 'Grid1' });
    let gridObj2: Grid;
    let elem2: HTMLElement = createElement('div', { id: 'Grid2' });
