...
var Grid = (function (_super) {
    ...
    Grid.prototype.getRowInfo = function (target) {
        var args = {};
        if (!isNullOrUndefined(target) && isNullOrUndefined(parentsUntil(target, 'e-detailrowcollapse')
            && isNullOrUndefined(parentsUntil(target, 'e-recordplusexpand')))) {
            var cell = closest(target, '.e-rowcell');
